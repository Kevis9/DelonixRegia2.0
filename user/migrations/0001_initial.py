# Generated by Django 2.2.4 on 2019-08-31 06:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admission_date', models.DateField(blank=True, null=True, verbose_name='在校时间开始')),
                ('graduate_date', models.DateField(blank=True, null=True, verbose_name='在校时间结束')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('followedby', models.ManyToManyField(related_name='follwedby', to=settings.AUTH_USER_MODEL, verbose_name='谁的朋友')),
