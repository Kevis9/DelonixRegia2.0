...
from user.models import FurtherEducation
import random
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        schoollist=['哈弗大学','牛津大学','麻省理工学院','斯坦福大学','哈佛大学','牛津大学','加州理工学院','清华大学','深圳大学','清华大学']
        ...
        for i in range(0,10):
            ...
            u1.save()
            fe1 = FurtherEducation.objects.create(uid=u1.id,major=majorlist[i], country=countrylist[i],uvty_name=schoollist[i], admission_date=3)
        ...
        u1.save()
        fe11 = FurtherEducation.objects.create(uid=u1.id,major=majorlist[0], country=countrylist[i],uvty_name=schoollist[0], admission_date=3)
        fe11 = FurtherEducation.objects.create(uid=u1.id,major=majorlist[0],country=countrylist[i], uvty_name=schoollist[1], admission_date=3)
